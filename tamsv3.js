...
(function () {
    ...
    function setAttributes(elements, attr, value) {
        processElements(elements, element => element.setAttribute(attr, value));
    }

    /**
     * Removes the given elements from the DOM.
     * @param {HTMLElement|HTMLElement[]} elements - The element(s) to remove.
     */
    function removeElements(elements) {
        processElements(elements, element => element.remove());
    }
    ...
    function processEl(selector, options) {
        ...
        if (typeof selector === 'string') {
            el = getElement(selector, options.all);
    ...
    GM_addElement(document.body, 'script', {
        src: 'https://cdn.jsdelivr.net/npm/core-js-bundle/minified.min.js'
    });
    ...
    GM_addStyle(`
        ...
        [data-bs-theme="dark"] {
            ...
            --bs-color: var(--bs-white-color);
            --bs-heading-color: var(--bs-white-color);
